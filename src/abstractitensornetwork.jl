...
# For ambiguity error; TODO: decide whether to use graph mutating methods when resulting graph is unchanged?
function _orthogonalize_edges(tn::AbstractITensorNetwork, edges::Vector{<:AbstractEdge}; kwargs...)
...
function ITensorMPS.orthogonalize(tn::AbstractITensorNetwork, edges::Vector{<:AbstractEdge}; kwargs...)
...
function ITensorMPS.orthogonalize(tn::AbstractITensorNetwork, edges::Vector{Pair}; kwargs...)
